...
function tabela(s, { head, rows, x = M, y, w, dark, colW, ultimaDestaque = false, rowH = 0.34 }) {
  const th = {
    ...
    border: [
      { type: 'none' },
      { type: 'none' },
      { pt: 0.75, color: dark ? LINE_D : LINE },
      { type: 'none' },
    ],
  };
...
// =====================================================================
{
  ...
  s.addNotes(
    'Abertura. O Propto é o sistema do corretor: ele fala e fotografa, o anúncio sai pronto.',
  );
}
...
// =====================================================================
{
  ...
  titulo(
    s,
    'O corretor autônomo perde a maior parte\ndo tempo produtivo em trabalho administrativo.',
    false,
    { size: 29 },
  );
  tabela(s, {
  ...
  nota(
    s,
    'Trinta imóveis em carteira, ao ritmo de hoje, consomem entre 60 e 150 horas só de trabalho administrativo. É a semana inteira do corretor, todo mês, em algo que não é venda.',
    false,
    6.3,
    { h: 0.5 },
  );
  s.addNotes(
    'Duas a cinco horas por imóvel. É por isso que a carteira do corretor autônomo é pequena.',
  );
}
...
// =====================================================================
{
  ...
  sub(
    ...
    true,
    { y: 4.0, w: 9.6, h: 1.2, size: 14 },
  );
  s.addText(
    'quem tem a captura tem o dado   ·   quem tem o dado tem o encontro   ·   quem tem o encontro tem a venda',
    {
      x: M,
      y: 5.5,
      w: W - M * 2,
...
// =====================================================================
{
  ...
  s.addShape(pres.ShapeType.roundRect, {
    ...
    line: { color: LINE_D, width: 0.75 },
  });
  s.addText('HOJE, SEM O PROPTO', {
    x: M + 0.32,
    y: by + 0.3,
    w: bw - 0.64,
    h: 0.24,
  ...
  s.addText('Trabalho humano do início ao fim, espalhado por vários dias e vários aplicativos.', {
    x: M + 0.32,
    y: by + 1.5,
    w: bw - 0.64,
    h: 0.8,
  ...
  s.addShape(pres.ShapeType.roundRect, {
    ...
    rectRadius: 0.06,
    fill: { color: '2A1614' },
    line: { color: RED_L, width: 1 },
  });
  s.addText('META DO PRODUTO', {
    x: x2 + 0.32,
    y: by + 0.3,
    w: bw - 0.64,
    h: 0.24,
  ...
  s.addText(
    'Sendo menos de 5 minutos de trabalho humano. O resto é a máquina processando enquanto o corretor vai para a próxima visita.',
    {
      x: x2 + 0.32,
      y: by + 1.5,
      w: bw - 0.64,
  ...
  nota(
    s,
    'As duas métricas-mãe do produto: tempo até publicar e tempo de trabalho humano. É possível ter a primeira boa e a segunda ruim — nesse caso o produto não resolveu nada, só mudou o trabalho de lugar.',
    true,
    5.5,
  );
...
// =====================================================================
{
  ...
  const etapas = [
    [
      'Capturar',
      'O corretor grava falando enquanto anda pelo imóvel e fotografa. Funciona sem internet.',
    ],
    [
      'Entender',
      'A fala vira ficha estruturada, com confiança e o trecho de áudio que originou cada dado.',
    ],
    ['Organizar', 'As fotos são classificadas por ambiente, ordenadas e a capa é escolhida.'],
    [
      'Tratar',
      'Exposição, enquadramento, e o obrigatório: rosto e placa borrados, metadados removidos.',
    ],
    [
      'Escrever',
      'Título, descrição e destaques, mais as versões para portal, Instagram e WhatsApp.',
    ],
    [
      'Apresentar',
      'Uma página própria do imóvel, rápida, com ficha, galeria e o CRECI do responsável.',
    ],
    [
      'Publicar',
      'Link único para mandar no WhatsApp, com cartão de prévia gerado automaticamente.',
    ],
    ['Acompanhar', 'Visita, clique e mensagem viram lead no funil, com alerta quando esfria.'],
    [
      'Encontrar comprador',
      'Imóvel novo varre a base de compradores. Comprador novo varre a carteira.',
    ],
  ];
  const cols = 3,
    gap = 0.3,
...
// =====================================================================
{
  ...
  grade(
    ...
    [
      {
        k: 'Gravação',
        t: 'Grava com a tela bloqueada',
        p: 'O corretor guarda o celular no bolso e continua falando. Sobrevive a ligação recebida.',
      },
      {
        k: 'Campo',
        t: 'Funciona sem internet',
        p: 'Cem por cento da captura é offline. O áudio entra na fila e sobe sozinho quando a rede voltar.',
      },
      {
        k: 'Extração',
        t: 'Confiança campo a campo',
        p: 'Cada dado vem com o quanto o sistema confia nele. Abaixo de 0,7 aparece destacado — não passa em silêncio.',
      },
      {
        k: 'Prova',
        t: 'Áudio-âncora',
        p: 'Ao tocar em um campo, o trecho exato da gravação que originou aquele dado toca de volta. O corretor ouve a prova.',
      },
      {
        k: 'Fotos',
        t: 'Até 40 por imóvel',
        p: 'Envio resiliente: sobrevive ao aplicativo ser fechado no meio e retoma de onde parou.',
      },
      {
        k: 'Correção',
        t: 'Complemento sem perder edição',
        p: 'Gravar de novo para completar não apaga o que o corretor já corrigiu à mão.',
      },
    ],
...
// =====================================================================
{
  ...
  sub(
    s,
    'Isso não é uma opção de configuração. É uma restrição do banco de dados: a foto só recebe o estado "pronta" se rosto e placa estiverem borrados e os metadados removidos. E só foto pronta é publicável.',
    true,
    { y: 2.14, w: 10.6, h: 0.8, size: 13.5 },
  );
  grade(
    s,
    [
      {
        k: 'Obrigatório',
        t: 'Rosto e placa borrados',
        p: 'Meta de 95% de recall. Falso negativo aqui é exposição jurídica, não defeito estético.',
      },
      {
        k: 'Obrigatório',
        t: 'Metadados removidos',
        p: 'A foto do celular carrega a coordenada de onde foi tirada. Sai antes de ir ao ar.',
      },
      {
        k: 'Automático',
        t: 'Exposição e perspectiva',
        p: 'Corrige foto escura e parede torta. O original é preservado, sempre.',
      },
      {
        k: 'Automático',
        t: 'Descarte sugerido',
        p: 'Foto tremida, escura ou repetida é apontada. Duplicata é detectada por cálculo, não por opinião.',
      },
    ],
...
// =====================================================================
{
  ...
  s.addText(
    'Título de até 70 caracteres, descrição longa e de três a seis destaques. Mais as versões por canal: portal, legenda de Instagram com hashtags, mensagem curta de WhatsApp e a descrição de busca para o Google.',
    {
      x: M,
      y: 2.72,
      w: 5.6,
  ...
  s.addText(
    'Nem qualquer referência a perfil de morador — família, religião, origem, estado civil, presença de crianças.',
    {
      x: M,
      y: py + 0.44,
      w: 5.6,
  ...
  card(s, {
    ...
    tint: SAND_2,
    dark: false,
    k: 'Como o fiscal trabalha',
    t: 'Primeiro a conta, depois a leitura',
  ...
  nota(
    s,
    'Campo que não foi dito vira vazio, nunca estimativa. Não inventar é regra dura: uma regressão em alucinação trava a entrega do código.',
    false,
    6.18,
    { h: 0.44 },
  );
...
// =====================================================================
{
  ...
  grade(
    ...
    [
      {
        k: 'Página',
        t: 'Endereço próprio e rápido',
        p: 'Galeria, ficha técnica, mapa e os dados do corretor. Carrega em menos de 2,5 segundos no 4G.',
      },
      {
        k: 'Privacidade',
        t: 'Endereço em três níveis',
        p: 'Exato, só a rua, ou só o bairro. O corretor escolhe por imóvel e vê antes o que o público verá.',
      },
      {
        k: 'Distribuição',
        t: 'Cartão pronto para o WhatsApp',
        p: 'Ao colar o link aparece preço, código e foto. O botão abre a conversa com a mensagem já escrita.',
      },
      {
        k: 'Medição',
        t: 'Visita e clique registrados',
        p: 'Sem guardar IP de ninguém. O corretor sabe quantos viram; ninguém sabe quem foram.',
      },
      {
        k: 'Funil',
        t: 'Lead vira negócio sozinho',
        p: 'Quem preenche o formulário entra no funil de oito estágios, com o consentimento registrado palavra por palavra.',
      },
      {
        k: 'Encontro',
        t: 'Busca nos dois sentidos',
        p: 'Imóvel novo varre a base de compradores; comprador novo varre a carteira, com justificativa em texto.',
      },
    ],
...
// =====================================================================
{
  ...
  sub(
    s,
    'Nenhum deles escreve no banco de dados. Todos devolvem confiança. Saída fora do formato esperado é descartada, não remendada.',
    true,
    { y: 2.3, w: 10, h: 0.5, size: 13 },
  );
  const agentes = [
    [
      'A1 · Transcritor',
      'transcribe',
      'Converte a fala em texto com marcação de tempo, com glossário de jargão imobiliário.',
    ],
    [
      'A2 · Extrator',
      'extract_property',
      'Transforma a fala corrida em ficha estruturada. O agente mais importante do produto.',
    ],
    [
      'A3 · Curador de mídia',
      'classify_photo',
      'Classifica o ambiente, dá nota à foto e detecta rosto, placa e item pessoal.',
    ],
    [
      'A4 · Redator',
      'write_listing',
      'Escreve o anúncio a partir apenas dos dados confirmados pelo corretor.',
    ],
    [
      'A5 · Compliance',
      'compliance_check',
      'Portão obrigatório. Aprova ou bloqueia, apontando o que está errado.',
    ],
    [
      'A6 · Faixa de preço',
      'price_range',
      'Faixa indicativa com comparáveis e ressalvas. Nunca chamada de avaliação.',
    ],
    [
      'A7 · Perfilador',
      'extract_requirements',
      'Extrai o que o comprador quer, separando o essencial do desejável.',
    ],
    [
      'A8 · Matcher',
      'match_explain',
      'Explica por que imóvel e comprador casam. A nota é calculada em código, não pelo modelo.',
    ],
    [
      'A9 · Follow-up',
      'suggest_followup',
      'Sugere a próxima mensagem ao lead. Nunca envia: abre o WhatsApp preenchido.',
    ],
  ];
  const cols = 3,
    gap = 0.34,
  ...
  nota(
    s,
    'O violeta identifica conteúdo proposto por inteligência artificial — no produto inteiro, essa cor só aparece onde a máquina propôs algo que o corretor ainda vai confirmar.',
    true,
    6.38,
    { h: 0.42, size: 10 },
  );
...
// =====================================================================
{
  ...
  grade(
    ...
    [
      {
        k: 'Direito de imagem',
        t: 'Anonimização bloqueante',
        p: 'Publicar rosto ou placa legível é risco real. A foto não chega à área pública sem tratamento: a regra está no banco, não na boa vontade do usuário.',
      },
      {
        k: 'Lei 6.530/1978',
        t: 'CRECI na página',
        p: 'Só publica imóvel de corretor com CRECI informado, e o número aparece no anúncio.',
      },
      {
        k: 'Lei 13.709/2018',
        t: 'Consentimento versionado',
        p: 'Fica gravado o texto exato que a pessoa leu ao aceitar. Sem consentimento, a mensagem não é enviada. Visitas são contadas sem guardar IP.',
      },
      {
        k: 'Defesa do consumidor',
        t: 'Anúncio que não promete',
        p: 'Número divergente do cadastro e promessa sem base bloqueiam a publicação. O anúncio só afirma o que está no dado.',
      },
    ],
  ...
  nota(
    s,
    'Cada corretor enxerga apenas a própria carteira e os próprios leads. O isolamento é verificado por teste automático que impede a entrega do código se falhar.',
    false,
    5.9,
    { h: 0.44 },
  );
...
// =====================================================================
{
  ...
  titulo(
    s,
    'A inteligência artificial é um ativo da casa,\nnão uma peça dentro do aplicativo.',
    true,
    { size: 28 },
  );
  sub(
    s,
    'O AI Gateway é um serviço independente. Roteia cada tarefa para o modelo certo, troca de provedor sozinho quando um falha, corta o gasto quando o orçamento acaba e registra custo por organização e por tarefa. Três produtos da PrimeCorp usam a mesma infraestrutura.',
    true,
    { y: 2.36, w: 10.6, h: 0.9, size: 13 },
  );
  grade(
    s,
    [
      { k: 'Propto', t: 'Imóveis', p: 'Transcrição, extração, fotos, redação e compliance.' },
      {
        ...
        p: 'Mesmo gateway, chave própria, orçamento próprio.',
      },
...
// =====================================================================
{
  ...
  titulo(s, '730 mil corretores no Brasil.\nComeçamos por um perfil específico.', false, {
    size: 29,
  });
  s.addText('Quem é o cliente do primeiro ano', {
    x: M,
    y: 2.6,
    w: 6,
    h: 0.3,
  ...
  card(s, {
    ...
    dark: false,
    k: 'Onde começa',
    t: 'Campinas e Sumaré, com carteira real',
  ...
  card(s, {
    ...
    h: 1.9,
    dark: false,
    k: 'Fora do escopo agora',
    t: 'Imobiliária com equipe, incorporadora, gestão de locação',
...
// =====================================================================
{
  ...
  nota(
    s,
    'Preço é hipótese declarada, a ser validada no piloto. O limite de capturas existe porque o custo de inteligência artificial é variável e real.',
    true,
    4.62,
    { w: 5.9, h: 0.9 },
  );
  s.addText('A aritmética, sem maquiagem', {
    x: 7.1,
    y: 2.5,
    w: 5.5,
    h: 0.3,
  ...
  nota(
    s,
    'A meta de 80% é de longo prazo, por cache semântico, escolha de modelo por tarefa e reprecificação. A meta da primeira versão é 40%. Se o uso real ficar perto do teto, o preço sobe ou o limite cai — é decisão de dado, marcada no calendário.',
    true,
    5.46,
    { x: 7.1, w: W - M - 7.1, h: 1.3, size: 10 },
  );
...
// =====================================================================
{
  ...
  grade(
    ...
    [
      {
        k: 'Pronto',
        t: 'Banco de dados completo',
        p: 'Organizações, imóveis, captura, fila, mídia e leads — com as travas de LGPD dentro do banco.',
      },
      {
        k: 'Pronto',
        t: 'Gateway e tratamento de imagem',
        p: 'Roteamento, troca de provedor, orçamento e cache. Borrão conferido pixel a pixel.',
      },
      {
        k: 'Pronto',
        t: 'Marca, site e página do imóvel',
        p: 'Identidade visual, site de vendas e a página do imóvel lendo do banco.',
      },
      {
        k: 'Falta',
        t: 'Aplicativo de captura',
        p: 'A tela onde o corretor grava e fotografa. É o coração do produto e o próximo item.',
      },
      {
        k: 'Falta',
        t: 'Painel do corretor',
        p: 'Entrar, revisar o rascunho, publicar e ver os leads sem depender de ninguém.',
      },
      {
        k: 'Falta',
        t: 'CRM, encontro e cobrança',
        p: 'Funil, busca comprador × imóvel e a assinatura com pagamento.',
      },
    ],
...
// =====================================================================
{
  ...
  sub(
    s,
    'Dez sprints até a versão completa é tempo demais para descobrir se alguém paga. Por isso existe o Piloto Zero: em dezembro, três corretores usam a captura na carteira real e pagam um valor simbólico. O objetivo não é faturar, é medir disposição a pagar.',
    true,
    { y: 2.2, w: 10.6, h: 0.9, size: 13 },
  );
  const fases = [
    ...
    [
      '26 DEZ · PORTÃO',
      'Piloto Zero',
      '3 corretores reais, 2 semanas. Sem aprovação aqui, não se constrói o CRM',
      RED_L,
    ],
    [
      'JAN — FEV',
      'CRM e encontro',
      'Funil, busca comprador × imóvel, painel de custo, lojas',
      LINE_D,
    ],
  ];
  ...
  nota(
    s,
    'O portão tem critério objetivo: 70% dos imóveis cadastrados por voz, mediana abaixo de 15 minutos, anúncios publicados com edição leve, e ao menos um corretor pagando por vontade própria. Falhando, a decisão é corrigir a captura — não construir CRM sobre uma captura que ninguém quis.',
    true,
    5.6,
  );
...
// =====================================================================
{
    ...
    [
      {
        k: 'Adoção',
        t: '70% por voz',
        p: 'Dos imóveis cadastrados no período, ao menos setenta por cento entram pela captura falada.',
      },
      {
        k: 'Velocidade',
        t: 'Menos de 15 minutos',
        p: 'Mediana da primeira gravação ao anúncio publicado.',
      },
      {
        k: 'Qualidade',
        t: '60% com edição leve',
        p: 'A maioria das descrições publicada alterando menos de um quinto do texto. Mede o que o corretor fez, não o que ele disse.',
      },
      {
        k: 'Custo',
        t: 'Menos de R$ 3 por imóvel',
        p: 'Acima disso, o gateway rebaixa a qualidade do modelo automaticamente e registra o rebaixamento.',
      },
      { k: 'Uso', t: '5 corretores por semana', p: 'Usando sem nenhum incentivo para usar.' },
      {
        k: 'Receita',
        t: '3 assinaturas pagas',
        p: 'Ao fim do piloto. Uma delas já no Piloto Zero, em dezembro.',
      },
    ],
  ...
  nota(
    s,
    'Falhar em adoção, em qualidade ou em receita significa repensar o produto — não iterar o código. E há uma métrica que nunca pode piorar: invenção de característica que o imóvel não tem. A meta é zero, e uma regressão nela para a venda até ser resolvida.',
    false,
    5.9,
    { h: 0.5 },
  );
...
// =====================================================================
{
  ...
  const contatos = [
    ['Site', 'propto.com.br'],
    ['WhatsApp', '+55 19 99805-1985'],
    ['Responsável', 'Rodrigo Viana · CRECI-SP'],
  ];
