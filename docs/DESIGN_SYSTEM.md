...
Exemplo de vazio na carteira: _"Sua carteira está vazia. Vá até um imóvel, aperte gravar e fale. O Propto faz o resto."_ + `[Gravar primeiro imóvel]`.
